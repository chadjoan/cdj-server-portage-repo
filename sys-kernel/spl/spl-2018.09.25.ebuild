...
if [[ ${PV} == "2018.09.25" ]] ; then
	AUTOTOOLS_AUTORECONF="1"
	# NOTE: It seems like the devs moved a bunch of this project into the ZFS repository by the end of this commit.
	EGIT_COMMIT="5712fadef19a28d27038b04f8267f29109794fc3"

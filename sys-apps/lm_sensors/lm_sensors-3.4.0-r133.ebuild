...
inherit eutils linux-info multilib systemd toolchain-funcs git-r3

EGIT_COMMIT="8fb3922219d3c6656b3902d6ae907de9e443797c"
EGIT_REPO_URI="https://github.com/groeck/lm-sensors.git"
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-8fb3922-sensors-detect-gentoo.patch

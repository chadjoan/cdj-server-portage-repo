...
if [ ${PV} == "2019.06.12" ]; then
	inherit autotools git-r3
	# Commit cfc16f8 doesn't pass all CI tests, but at this point in history
	# most of the failed commits are due to just Fedora's CI test failing.
	# There are more recent commits that tend to fail more than just Fedora's
	# CI tests, and I chose to avoid those.
	# This commit is titled "Improve ZTS block_device_wait debugging"
	# and it is from 2019-06-10.
	AUTOTOOLS_AUTORECONF="1"
	EGIT_COMMIT="cfc16f8ba8e6e35fc4651059ee95abbb8bf92f62"
	EGIT_REPO_URI="https://github.com/zfsonlinux/${PN}.git"

	EGIT_OVERRIDE_COMMIT_ZFSONLINUX_ZFS="cfc16f8ba8e6e35fc4651059ee95abbb8bf92f62"
	EGIT_OVERRIDE_COMMIT_ZFSONLINUX_ZFS_IMAGES="e8a83740472c2aa843499a424507eb518fce76e4"
else
...
pkg_postinst() {
	...
	if ! use kernel-builtin && [[ ${PV} = "2019.06.12" ]]; then
